      ...
      <div className="relative">
        ...
        <div className="relative flex gap-2 sm:gap-4 md:gap-6 items-center">
          ...
          <img 
            src="/phone-budgy.png" 
            alt="Budget App" 
            className="w-[150px] h-[300px] xs:w-[180px] xs:h-[360px] sm:w-[220px] sm:h-[440px] md:w-[280px] md:h-[560px] lg:w-[320px] lg:h-[640px] object-contain drop-shadow-2xl transform hover:scale-105 transition-transform duration-500 z-10"
          />
          <img 
            src="/phone-budgy.png" 
            alt="Budget App" 
